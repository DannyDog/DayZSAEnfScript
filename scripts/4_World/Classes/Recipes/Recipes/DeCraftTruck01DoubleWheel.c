class DeCraftTruck01DoubleWheel extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_DeCraftTruck01DoubleWheel0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Truck_01_WheelDouble");//you can insert multiple ingredients this way
	...
	override bool CanDo(ItemBase ingredients[], PlayerBase player)//final check for recipe's validity
	{
		...
		if ( !ingredient1.GetHierarchyParent() )
			return true;
		else
			return false;
	}
