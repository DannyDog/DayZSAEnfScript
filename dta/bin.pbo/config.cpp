...
class CfgVehicles
{
	...
	class Car: Transport
	{
		...
		simulation="car";
		fuelCapacity=100;
		brakeFluidCapacity=5.0999999;
		oilCapacity=4.1999998;
		coolantCapacity=3.5;
		canFloat=0;
		armorLights=0.40000001;
		...
		class Weather
		{
			class LightingNew
			{
				class C_Day60
				{
					...
					desiredLuminanceCoef=0.72000003;
					desiredLuminanceCoefCloud=0.72000003;
					EVMin=-2;
					EVMax=1;
