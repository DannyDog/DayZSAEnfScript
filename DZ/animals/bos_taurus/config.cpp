...
class CfgVehicles
{
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"dz\animals\bos_taurus\data\bull_brown_CO.paa"};
		hiddenSelectionsMaterials[] = {"dz\animals\bos_taurus\data\bull_brown.rvmat"};
	};
	class Animal_BosTaurus_White: Animal_BosTaurus
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"dz\animals\bos_taurus\data\bull_white_CO.paa"};
		hiddenSelectionsMaterials[] = {"dz\animals\bos_taurus\data\bull_white.rvmat"};
	};
	class Animal_BosTaurus_Spotted: Animal_BosTaurus
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"dz\animals\bos_taurus\data\bull_spotted_CO.paa"};
		hiddenSelectionsMaterials[] = {"dz\animals\bos_taurus\data\bull_spotted.rvmat"};
	};
};
