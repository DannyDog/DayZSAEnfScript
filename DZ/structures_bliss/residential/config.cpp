...
class CfgVehicles
{
	...
	class Land_BusStop_Village2: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures_bliss\Residential\Bus\BusStop_Village2.p3d";
	};
	class Land_House_1W13_Dam: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_PoliceStation_Enoch: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Village_PoliceStation_Enoch: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House3: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House4: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House5: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House6: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Slum_House7: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\structures_bliss\Residential\Slums\Slum_House7.p3d";
	};
	class Land_Village_Store_Enoch: HouseNoDestruct
	{
		scope = 1;
