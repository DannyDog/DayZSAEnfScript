...
class CfgVehicles
{
	...
	class BandanaHead_RedPattern: BandanaHead_ColorBase
	{
		scope = 2;
		color = "redpattern";
		ChangeIntoOnAttach[] = {"","BandanaMask_RedPattern"};
	...
	class BandanaHead_BlackPattern: BandanaHead_ColorBase
	{
		...
		visibilityModifier = 0.9;
		color = "blackpattern";
		ChangeIntoOnAttach[] = {"","BandanaMask_BlackPattern"};
	...
	class BandanaHead_PolkaPattern: BandanaHead_ColorBase
	{
		scope = 2;
		color = "polkapattern";
		ChangeIntoOnAttach[] = {"","BandanaMask_PolkaPattern"};
	...
	class BandanaHead_Greenpattern: BandanaHead_ColorBase
	{
		...
		visibilityModifier = 0.9;
		color = "greenpattern";
		ChangeIntoOnAttach[] = {"","BandanaMask_GreenPattern"};
	...
	class BandanaHead_CamoPattern: BandanaHead_ColorBase
	{
		...
		visibilityModifier = 0.85;
		color = "camopattern";
		ChangeIntoOnAttach[] = {"","BandanaMask_CamoPattern"};
	...
	class BoonieHat_ColorBase: Clothing
	{
		...
		repairableWithKits[] = {5,2};
		repairCosts[] = {30.0,25.0};
		headSelectionsToHide[] = {"Clipping_BoonieHat"};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale"};
		class DamageSystem
		{
			class GlobalHealth
	...
	class OfficerHat: Clothing
	{
		...
		repairableWithKits[] = {5,2};
		repairCosts[] = {30.0,25.0};
		headSelectionsToHide[] = {"Clipping_OfficerHat"};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale"};
	...
	class PoliceCap: Clothing
	{
		...
		repairableWithKits[] = {5,2};
		repairCosts[] = {30.0,25.0};
		headSelectionsToHide[] = {"Clipping_Policecap"};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale"};
