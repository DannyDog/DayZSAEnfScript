...
class CfgVehicles
{
	...
	class Church: HouseNoDestruct{};
	class Land_Misc_Polytunnel: HouseNoDestruct
	{
		scope = 2;
	...
	class Land_BusStop_City: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures\Residential\Bus\BusStop_City.p3d";
	};
	class Land_City_FireStation: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_1F_Corner: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_1F1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_1F2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_1F3: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_1F4: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F_Corner: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F3: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F4: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F5: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F6: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F7: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F8: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_2F9: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_3F_Corner1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_3F_Corner2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_3F1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_3F2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_HouseBlock_5F: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Stand_FastFood: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Stand_Grocery: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Stand_News1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Stand_News2: HouseNoDestruct
	{
		scope = 1;
		...
		class UserActions
		{
			class Shutter1Open
			{
				displayName = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter1Open0";
				displayNameDefault = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter1Open1";
			...
			{
				displayName = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter1Close0";
				displayNameDefault = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter1Close1";
				condition = "this animationPhase ""shutter1"" >= 0.5 && damage this < 1";
				statement = "this animate [""shutter1"",0];";
			};
			class Shutter2Open: Shutter1Open
			{
				displayName = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter2Open0";
				displayNameDefault = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter2Open1";
			...
			{
				displayName = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter2Close0";
				displayNameDefault = "$STR_CfgVehicles_Land_City_Stand_News2_UserActions_Shutter2Close1";
				condition = "this animationPhase ""shutter2"" >= 0.5 && damage this < 1";
				statement = "this animate [""shutter2"",0];";
			};
		};
	};
	class Land_House_1B01_Pub: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W01: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W02: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W03: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W04: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W05: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W07: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W08: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_1W12: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_2B02: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_2B03: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_2B04: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_2W01: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_2W02: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_House_2W03: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Hospital: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Village_HealthCare: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Medical_Tent_Big: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures\Residential\Medical\Medical_Tent_Big.p3d";
	};
	class Land_Medical_Tent_Shower: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Misc_DogHouse: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures\Residential\Misc\Misc_DogHouse.p3d";
	};
	class Land_Misc_DeerStand2: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures\Residential\Misc\Misc_DeerStand2.p3d";
	};
	class Land_Misc_DeerStand1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Misc_Well_Pump_Blue: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Lamp_City1_amp: HouseNoDestruct
	{
	...
	class Land_Office_Municipal1: Church
	{
		scope = 1;
		simulation = "church";
	...
	class Land_Office_Municipal2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Office1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Office2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Village_PoliceStation: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_PoliceStation: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_School: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_M1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_M3: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_M4: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures\Residential\Sheds\Shed_M4.p3d";
	};
	class Land_Shed_W1: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_W2: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_W3: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_W5: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Shed_W6: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Store: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_City_Store_WithStairs: Land_City_Store
	{
	...
	class Land_Tenement_Big: HouseNoDestruct
	{
		scope = 1;
	...
	class Land_Tenement_Small: HouseNoDestruct
	{
		scope = 1;
